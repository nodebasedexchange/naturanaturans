...
print(glasbey.extend_palette("#453B32", palette_size=16, lightness_bounds=(20, 40), chroma_bounds=(10, 30)))
sea.set()
sea.palplot(glasbey.extend_palette("#453B32", palette_size=16, lightness_bounds=(20, 40), chroma_bounds=(10, 30)))
plt.show()
